...
Kaine crouched at the nearest of the marks without touching it, his light tracking from one glyph to the next down the row. "It's the same one every time. Same strokes, same order, not a slip in the lot of them." He didn't look up. "You don't get a hand that steady doing a thing once. They've drawn this before — a lot." The words settled into the cold with everything else, and with them a thought none of them said aloud: that there were other rooms, on other worlds, wearing this same signature, and that someone out there knew exactly what it meant.
