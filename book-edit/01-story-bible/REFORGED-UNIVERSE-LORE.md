...
- **Creator of the Dra'Kor Vhel'Tan:** commissioned the task force to **quell the Kresh rebellion.** ✅ *Reconciles with Drakken's card:* **Vrakar created/willed it; Drakken forged & led it** (trained the twins Lythar & Rythos). The subdued **Kresh** were relegated to lesser roles, **barred eternally from the Highborn Vanguard.**
- **The Highborn Guard / Vanguard:** Vrakar's **personal guard of ~five elite warriors** (hand-picked from the Blackguard's finest), led by **Commandant Thal'Rak Cho'Vall**. The **original** Vanguard — the armada's **Titan Vanguard** (Kyr's central force) is a **derivative** of it. Distinct from Drakken's **Blackguard**. *(⚠️ name: "Highborn Guard" per its own card vs "Highborn Vanguard" per this card/your derivation logic — see its full entry + flag.)*
...
**The Kresh** — **NEW faction.** A ferocious Obsidian warrior species (one of the five). **Arc:** they **rebelled** → the rebellion was **quelled by the Dra'Kor Vhel'Tan** (Vrakar's task force, forged by Drakken) → the subdued Kresh were **relegated to lesser roles and barred eternally from the Highborn Vanguard** as a reminder of defiance → later, **Kyr Tharanos won their pride and loyalty**, integrating them with honor into the **Titan Vanguard** (the first leader to do so). They fought on Trident under Drakken's combined command.

**Titan Vanguard** — **NEW unit.** The **central / principal fighting force of the Obsidian armada** — and a **derivative of the Highborn Vanguard** (Vrakar's personal guard). *That shared lineage is why "Vanguard" appears in both names — deliberate, not a clash.* Kyr's origin and command; operates with Kresh counterparts. **A Titan Vanguard division was annihilated at New Eridanus by Charles's nuke** (the epilogue's "ground division swallowed by a single human's fire") — the failure Kyr is summoned to answer for, and the spark for Vrakar committing the Vanguard/Kresh in force.

**The Highborn Guard** — *(⚠️ **name conflict:** Vrakar's card + your derivation logic call this the **"Highborn Vanguard"**; this dedicated card titles it **"The Highborn Guard."** Pick one — the "Vanguard" form preserves the Titan-Vanguard-derives-from-it lineage. Flagged in Discrepancy Report B2c.)* — Vrakar's **elite personal guard** (~5 elite warriors), drawn from **the finest of the Blackguard**; the shield of the Highlord. Reference: `assets/highborn-guard.png`.
...
- Obsidian: **Highlord Vrakar** · **Drakken Thik'Shal** · **Kyr Tharanos** · **Princess Lyrana** · **Thal'Rak Cho'Vall** · **Lythar** & **Rythos** · **Kresh** · **Titan Vanguard** · **Highborn Guard/Vanguard** *(name TBD)* · **Blackguard** · **Dra'Kor Vhel'Tan** · **Lar'Kar Zhul** · **Councillor Vorthan** / **Councillor Talira** · **War of the Five Suns** · **Sacred Retribution** · flagship **Krath'Zaroth** · warship **Pillar of Anguish**.
