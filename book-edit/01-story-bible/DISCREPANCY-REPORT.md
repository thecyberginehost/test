...
- ⭐ **Power scale & true nature (author-canon):** Mindreaving is secretly a **very low-level use of conduit energy** (the Xylaris/Harbinger power), unknown to its users. **GRID rates it 1–10** (10 = max): **Strickland ("the Demon") = 10**; **the Surgeon = 7.** Even a 10 is **far weaker than pre-Reckoning Mindreaving** — modern Mindreavers are a faint echo of the ancients, and a *dormant* proto-Harbinger potential (full detail in REFORGED-UNIVERSE-LORE §5).
