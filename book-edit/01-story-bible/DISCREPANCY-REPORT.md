...
**🆕 Flags created by the cut — ✅ ALL RESOLVED (author rulings 2026-06-05)**
- **N1 — Royce's payoff → ✅ relocated to Book 2.** Royce **survives Book 1.** He **dies in Book 2**, on one of the final missions, **right before Argus's last stand.** No hero-death needed in Book 1; just protect his rookie→hero trajectory so the Book-2 payoff lands.
- **N2 — Junior's survival → ✅ deferred to Book 2 (leave uncertain in Book 1).** Argus knows Junior is **critical** (he saw it at the house, with Julia & Kat dead). His survival is only **confirmed in Book 2**, when Argus loads **Tessa + Junior** onto one of the few ships escaping the planet. Argus nearly boards with them — then **sees one of the escape ships blown out of the sky**, so he **stays and makes a "Noble Six"-style last stand** (with author modifications). → **Book 1 correctly ends with Junior's fate unconfirmed on-page.** No change needed; do NOT add a confirmation line.
- **N3 — One nuke → ✅ LOCKED & PATCHED.** Only **one** nuke exists. **Ch12 patched** (`02-edited/12-A_Loss_for_Words.md`): the Delta bunker now holds *"one of the last portable nuclear devices… a single warhead, with no promise of another… One device. One chance."* *(Chain-of-custody now CLOSED: a custody beat added in Ch16 establishes Valor pulled the single warhead from Delta and handed it to **Ironclad** to carry to the objective — so Charles having "our nuke" and the ending's "Ironclad carried the only one we had" both pay off. Minor note: a throwaway Ch5 line gives Valor's Guardian Drones "tactical nukes" — keep as a distinct micro-asset class, not the warship warhead.)*
- **N4 — Two artifacts → ✅ confirmed TWO.** **Artifact #1** = the one **Elena Voss studies at Gladius/GRID Section-47** (Ch13; the Harbinger/knowledge artifact) — *the first one.* **Artifact #2** = the **corrupted/Void artifact buried under New Eridanus**, what the **Pillar of Anguish is excavating** for; **Death Platoon finds it in Book 2.** Keep them clearly distinct in Ch13–16.
- **N5 — Wraith/Tor/Eclipse → ✅ clean.** Their Ch17 re-entry is cut; **no earlier chapter promises their Book-1 return** (verified), so nothing to walk back.
...
### B2e. "Fringe" naming collision (✅ RESOLVED) + War-of-Five-Suns credit overlap (open)
- ✅ **RESOLVED:** the Obsidian black-ops unit was renamed **"Fringe Operatives" → "the Umbral Hand,"** clearing the clash with the human warship **GFC Fringe** (Harris's old ship, Ch14). *(Provisional name — easy to swap if the author prefers another.)*
- **Decisive-victory credit overlap (War of the Five Suns):** Vrakar's war-turning **Lok'Sha O'Ka** boarding is "set up" by **three** covert efforts across cards — **Kyr + Lyrana** (Titan Vanguard ship-infiltration sabotage) and the **Umbral Hand** (ion storm + feigned retreat vs the **Seleron** at the fourth sun). Likely the **same climactic victory with multiple covert hands** (or distinct suns). Lock **who did what / at which sun**. Low urgency.
...
- ✅ **ROURKE — AUTHOR RULING (2026-06-09, expanded):** **Foresight/Precognition + Feeling (two distinct modes).**
  - **Foresight (precognition):** *split-second* sight — he perceives a thing **right before** it happens; never enough lead time to plan around it, but decisive in a real-time fight.
  - **Feeling — mode 1 · emotional site-reading:** at a place where emotion ran **high and raw** (terrible *or* joyful), he can **feel what happened there**.
  - **Feeling — mode 2 · Mindreaver-detection:** he can **sense another Mindreaver's presence** — but *only if they're strong enough to trip it* — and this registers as a **distinctly different feeling** than the emotional residue of a place.
  - *(Classification: Feeling = a **Mindreaver application** — residue/presence-sensing, not live mind-reading — which keeps Ch2's "another Mindreaver on the team" true. ⭐ Canon payoffs already on the page: **Ch4's "unsettling tingling"** approaching Charr = mode-1 reading the massacre; **Ch5 "Rourke felt the cold press… 'Mindreaver!'"** and **Ch16 "a presence his Mindreaving identified as another Mindreaver"** = mode-2 detection. No manuscript change needed — the ruling makes the existing lines correct.)*
...
- ⭐ **AUTHOR CANON — the GFC "nuke" is NOT literally nuclear.** "Nuke" is just soldier-slang for a **high-yield tactical blast weapon** — devastating ~2 km radius (Halo-tactical-nuke style) — with **no fission/fusion, no fallout, no radiation.** So the radiation question is **moot** for *both* the Liberation (Ch8) and Charles/Rourke's warhead; the words "nuke/nuclear" in prose & dialogue are in-world colloquialism, no need to scrub. *(Ch16 softened "the electromagnetic pulse from the nuke" → "the pulse from the blast" to avoid implying fission.)*
...
### G14. Ch16 climax rewritten — Rourke + Charles two-man last stand — ✅ AUTHOR-DIRECTED, DONE
- ✅ **Author idea:** instead of Charles dying **alone**, **Rourke** gets cut off and joins him. **Mechanism (author-approved):** Valor attempts a **rescue** of the cut-off Ironclad and splits to pincer — **Argus + Harlan + Royce** one flank, **Rourke + Kaine** the other. An **enemy blast isolates Rourke** (Kaine is shoved back to Argus, which keeps Kaine alive to lead the tunnel); the rescue fails; Rourke, the only way left being *forward*, **fights solo to Charles** (his Foresight/Feeling reading the doom; his Mindreaver-detection + C5 beat relocated into this push). They make a **back-to-back last stand** and detonate the warhead together.
- **Canon-compatible:** Tessa is the **sole long-term Valor survivor** (locked), so Rourke dies somewhere in the series regardless — this spends it as a Book-1 blaze of glory. ⚠️ **Consequence: Rourke is NOT in Book 2.**
- **Emotional frame: grief, not guilt** (author's choice) — Argus *tries* to reach them and the battle tears them away; mirrors his helplessness with his family. *(Rejected alt: Argus ordering Rourke onto the nuke.)*
- **Reassignments/fixes:** Rourke's post-nuke tunnel line → **Harlan**; the reveal reworked so Argus surfaces both the dead nuke-plan **and** Rourke's death with Charles; Kaine's tunnel-from-youth reveal relocated to the rescue-fails moment (native-son thread C9 intact). **Draft — open to notes.**
