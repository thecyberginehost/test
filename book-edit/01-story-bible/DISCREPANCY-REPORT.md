...
- **N3 — One nuke → ✅ LOCKED & PATCHED.** Only **one** nuke exists. **Ch12 patched** (`02-edited/12-A_Loss_for_Words.md`): the Delta bunker now holds *"one of the last portable nuclear devices… a single warhead, with no promise of another… One device. One chance."* *(Residual: minor chain-of-custody — Valor secures the device at Delta, but Charles/Ironclad detonates it in Ch16. A one-line hand-off beat would tidy this; low priority. Also note a throwaway Ch5 line gives Valor's Guardian Drones "tactical nukes" — keep as a distinct micro-asset class, not the warship warhead.)*
