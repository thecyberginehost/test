...
- **GRID** — shadowy black-ops/R&D agency on Veridian Prime. ⚠️ **Not all operatives are Mindreavers** (correction): GRID fields **nano-augmented baseline super-soldiers** (Project Clandestine/Phantom — e.g., **Strickland/"Demon"**; physical enhancement only), **Neural-Ascension Mindreavers** (dormant ability awakened — e.g., **Junior**), and **natural Mindreavers** (e.g., **Wraith**). Cutting-edge tech. Distrusted by line Praetorians. ⭐ **Buried secret (series):** GRID has **secretly known about human↔alien (Vrak'Tharan) contact for centuries** — its Archives hold the **late-1800s photo of Khar'nik Shuk with Najoboro Takamoto** (Ujio's line); **no human in 2888 knows but GRID.** GRID sits on the true history. (See `REFORGED-UNIVERSE-LORE.md` — Ujio.)
- **Mindreavers** — humans (and some Obsidians) with psychic (conduit) ability. ✅ Spelling **locked: `Mindreaver`** (all "Mindweaver" fixed). ⚠️ Still open (B4): the power is shown as both *precognition ("foresight")* and *telepathy/thought-reading* — define/standardize. **NB:** Mindreaver ability is **innate/awakened (Neural Ascension)** — *separate* from **nano-augmentation** (Clandestine physical enhancement).
