...
- **Princess Lyrana** — **NEW (deep lore, not yet on-page).** The **heir of Vrakar** (his daughter); fearless warrior-strategist who fought beside Kyr in the War of the Five Suns. Relationship to Vrakar's corruption arc TBD. Major future character.
- **Commandant Thal'Rak Cho'Vall** — **NEW (deep lore).** Commander of the **Highborn Guard/Vanguard** (Vrakar's personal guard). His deeds are **"blacklisted from Obsidian logs"** — a deliberate mystery hook. Full lore in `REFORGED-UNIVERSE-LORE.md`.
